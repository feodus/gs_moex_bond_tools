...
Проект MOEX Bond Data for Google Sheets находится в активной разработке. Это библиотека Google Apps Script, которая предоставляет пользовательские функции для получения данных об облигациях с Московской Биржи прямо в Google Таблицах.
